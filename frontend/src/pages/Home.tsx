  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white w-full">
      ...
      <div className="w-full">
        <div className="w-full px-12 py-32 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-gray-900 p-8 rounded-xl border border-gray-800">
            ...
            <p className="text-gray-400">
              Complete information on every god including abilities, stats, and
              lore.
            </p>
          </div>
      ...
      <footer className="bg-black border-t border-gray-800 mt-20 w-full">
        <div className="w-full px-12 py-8 text-center text-gray-500">
