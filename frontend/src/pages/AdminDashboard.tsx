  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Link
          to="/admin/gods"
          className="bg-cyan-600 hover:bg-cyan-700 p-6 rounded-lg transition"
        >
        ...
        <Link
          to="/admin/items"
          className="bg-emerald-600 hover:bg-emerald-700 p-6 rounded-lg transition"
        >
        ...
        <Link
          to="/admin/builds"
          className="bg-violet-600 hover:bg-violet-700 p-6 rounded-lg transition"
        >
        ...
        >
          ...
          <p className="mt-2">Set Solo/Jungle/Mid/Carry/Support roles</p>
        </Link>
      </div>
    </div>
  );
